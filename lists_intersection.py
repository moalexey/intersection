...
my_result_filename  = 'not_unique_words.txt'
...
# Intersection
not_unique_words = set.intersection(*map(set, [filter(None, wordlist_1), filter(None, wordlist_2)]))

# Write result in file
with open(my_result_filename, 'w') as result:
    for word in not_unique_words:
